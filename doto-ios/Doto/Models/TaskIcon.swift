...
enum TaskIconCatalog {
    ...
    static let categories: [TaskIconCategory] = [
        TaskIconCategory(name: "Household", color: .memberAmber, icons: [
            ...
            TaskIcon("hammer.fill", "Fix / repairs"),
            TaskIcon("paintbrush.fill", "Painting"),
            TaskIcon("key.fill", "Lock up"),
        ]),
        TaskIconCategory(name: "Tech & Devices", color: .memberBlue, icons: [
            TaskIcon("iphone", "Phone"),
            TaskIcon("ipad", "iPad / Tablet", fallback: "iphone"),
            TaskIcon("laptopcomputer", "Laptop"),
            TaskIcon("desktopcomputer", "Computer"),
            TaskIcon("tv.fill", "TV"),
            TaskIcon("headphones", "Headphones"),
            TaskIcon("camera.fill", "Camera"),
            TaskIcon("applewatch", "Watch", fallback: "clock.fill"),
            TaskIcon("printer.fill", "Printer"),
            TaskIcon("hifispeaker.fill", "Speaker", fallback: "speaker.wave.2.fill"),
            TaskIcon("powerplug.fill", "Electronics", fallback: "bolt.fill"),
        ]),
        TaskIconCategory(name: "School & Learning", color: .memberBlue, icons: [
            ...
            TaskIcon("pencil", "Writing"),
            TaskIcon("scissors", "Arts & crafts"),
        ]),
        TaskIconCategory(name: "Kitchen & Errands", color: .memberGreen, icons: [
            TaskIcon("cart.fill", "Groceries"),
            TaskIcon("fork.knife", "Cooking"),
            TaskIcon("bag.fill", "Shopping"),
            TaskIcon("fuelpump.fill", "Gas station"),
            TaskIcon("bicycle", "Bike ride"),
        ...
        TaskIconCategory(name: "Food & Meals", color: .memberMaroon, icons: [
            ...
            TaskIcon("refrigerator.fill", "Frozen food", fallback: "snowflake"),
        ...
        TaskIconCategory(name: "Extracurricular", color: .memberRed, icons: [
            ...
            TaskIcon("soccerball", "Soccer", fallback: "figure.run"),
            TaskIcon("basketball.fill", "Basketball", fallback: "figure.run"),
            TaskIcon("football.fill", "Football", fallback: "figure.run"),
            TaskIcon("baseball.fill", "Baseball", fallback: "figure.run"),
        ...
        TaskIconCategory(name: "Outdoor & Seasonal", color: .memberBlue, icons: [
            TaskIcon("sun.max.fill", "Play outside"),
            TaskIcon("tree.fill", "Park", fallback: "leaf.fill"),
            TaskIcon("snowflake", "Snow"),
            TaskIcon("figure.walk", "Dog walking"),
            TaskIcon("tent.fill", "Camping", fallback: "mountain.2.fill"),
        ]),
        TaskIconCategory(name: "Family & Celebrations", color: .memberGreen, icons: [
            TaskIcon("gift.fill", "Birthday"),
            TaskIcon("balloon.fill", "Party", fallback: "gift.fill"),
            TaskIcon("person.3.fill", "Family time"),
